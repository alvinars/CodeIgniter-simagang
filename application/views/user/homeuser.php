...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>index.php/user" class="logo">
      ...
      <span class="logo-lg"><b>SIMAGANG</b></span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Teknik Siskom UNDIP 2018</small>
                </p>
              </li>
              <!-- Menu Body -->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <?php $this->load->view('user/usersidebar'); ?>
    </section>
    <!-- /.sidebar -->
  </aside>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="https://siskom.undip.ac.id">Teknik Komputer UNDIP 2018</a>.</strong> All rights
    reserved.
  </footer>
